...
async function main() {
  ...
  console.log('Comprehensive curriculum seeded successfully!')
  console.log(`Total lessons created: ${allLessons.length}`)
  console.log('Curriculum structure:')
  console.log('- Foundation Level: Lessons 1-20')
...
main()
  .catch((e) => {
    console.error('Error seeding comprehensive curriculum:', e)
    process.exit(1)
  })
  .finally(async () => {
